...
public class TimerH7 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("H7ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedH7", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectH7");
    }
}
