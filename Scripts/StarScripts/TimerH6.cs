...
public class TimerH6 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("H6ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedH6", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectH6");
    }
}
