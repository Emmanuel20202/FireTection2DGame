...
public class S1Star : MonoBehaviour
{
    public Image star1;
    public Image star2;
    public Image star3;
    ...
    void Start()
    {
        starsEarned = PlayerPrefs.GetInt("starsEarnedS1", 0);
        highestStarsEarned = PlayerPrefs.GetInt("highestStarsEarnedS1", 0);

        if (starsEarned > highestStarsEarned)
        {
            highestStarsEarned = starsEarned;
            PlayerPrefs.SetInt("highestStarsEarnedS1", highestStarsEarned);
            PlayerPrefs.Save();
        }
        else
        {
