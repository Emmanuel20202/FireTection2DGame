...
public class TimerS7 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("S7ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedS7", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectS7");
    }
}
