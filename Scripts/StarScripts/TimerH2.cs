...
public class TimerH2 : MonoBehaviour
{
    ...
    //               bwisit ka countdownImage.fillAmount = currentTime / 20f; // set the fill amount based on the current time
    ...
    {
        if (collision.gameObject.CompareTag("H2ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedH2", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectH2");
    }
}
