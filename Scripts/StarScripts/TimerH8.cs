...
public class TimerH8 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("H8ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedH8", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectH8");
    }
}
