...
public class B5Star : MonoBehaviour
{
    public Image star1;
    public Image star2;
    public Image star3;
    ...
    void Start()
    {
        starsEarned = PlayerPrefs.GetInt("starsEarnedB5", 0);
        highestStarsEarned = PlayerPrefs.GetInt("highestStarsEarnedB5", 0);

        if (starsEarned > highestStarsEarned)
        {
            highestStarsEarned = starsEarned;
            PlayerPrefs.SetInt("highestStarsEarnedB5", highestStarsEarned);
            PlayerPrefs.Save();
        }
        else
        {
