...
public class TimerH1 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("StoveCol"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedH1", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectH1");
    }
}
