...
public class H1Star : MonoBehaviour
{
    public Image star1;
    public Image star2;
    public Image star3;
    ...
    void Start()
    {
        starsEarned = PlayerPrefs.GetInt("starsEarnedH1", 0);
        highestStarsEarned = PlayerPrefs.GetInt("highestStarsEarnedH1", 0);

        if (starsEarned > highestStarsEarned)
        {
            highestStarsEarned = starsEarned;
            PlayerPrefs.SetInt("highestStarsEarnedH1", highestStarsEarned);
            PlayerPrefs.Save();
        }
        else
        {
