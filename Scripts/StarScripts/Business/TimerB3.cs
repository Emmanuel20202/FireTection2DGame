...
public class TimerB3 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("B3ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedB3", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectB3");
    }
}
