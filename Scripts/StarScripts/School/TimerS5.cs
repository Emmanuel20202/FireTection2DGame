...
public class TimerS5 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("S5ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedS5", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectS5");
    }
}
