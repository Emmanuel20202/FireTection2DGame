...
public class TimerS3 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("S3ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedS3", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectS3");
    }
}
