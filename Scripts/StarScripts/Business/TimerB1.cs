...
public class TimerB1 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("B1ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedB1", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectB1");
    }
}
