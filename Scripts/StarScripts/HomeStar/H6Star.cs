...
public class H6Star : MonoBehaviour
{
    public Image star1;
    public Image star2;
    public Image star3;
    ...
    void Start()
    {
        starsEarned = PlayerPrefs.GetInt("starsEarnedH6", 0);
        highestStarsEarned = PlayerPrefs.GetInt("highestStarsEarnedH6", 0);

        if (starsEarned > highestStarsEarned)
        {
            highestStarsEarned = starsEarned;
            PlayerPrefs.SetInt("highestStarsEarnedH6", highestStarsEarned);
            PlayerPrefs.Save();
        }
        else
        {
