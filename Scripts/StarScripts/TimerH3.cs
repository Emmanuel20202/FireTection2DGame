...
public class TimerH3 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("H3ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedH3", starsEarned);
        ...
        if (collision.gameObject.CompareTag("H3WrongCollide"))
        {
            ...
            StartCoroutine(LoadNextScene()); // load next scene after 2 seconds
            StartCoroutine(LoadNextScene2()); // load next scene after 2 seconds
        }
    }
