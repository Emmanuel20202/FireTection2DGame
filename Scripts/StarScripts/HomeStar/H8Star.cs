...
public class H8Star : MonoBehaviour
{
    public Image star1;
    public Image star2;
    public Image star3;
    ...
    void Start()
    {
        starsEarned = PlayerPrefs.GetInt("starsEarnedH8", 0);
        highestStarsEarned = PlayerPrefs.GetInt("highestStarsEarnedH8", 0);

        if (starsEarned > highestStarsEarned)
        {
            highestStarsEarned = starsEarned;
            PlayerPrefs.SetInt("highestStarsEarnedH8", highestStarsEarned);
            PlayerPrefs.Save();
        }
        else
        {
