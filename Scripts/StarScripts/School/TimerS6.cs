...
public class TimerS6 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("S6ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedS6", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectS6");
    }
}
