...
public class H3Star : MonoBehaviour
{
    public Image star1;
    public Image star2;
    public Image star3;
    ...
    void Start()
    {
        starsEarned = PlayerPrefs.GetInt("starsEarnedH3", 0);
        highestStarsEarned = PlayerPrefs.GetInt("highestStarsEarnedH3", 0);

        if (starsEarned > highestStarsEarned)
        {
            highestStarsEarned = starsEarned;
            PlayerPrefs.SetInt("highestStarsEarnedH3", highestStarsEarned);
            PlayerPrefs.Save();
        }
        else
        {
