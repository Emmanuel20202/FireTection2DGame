...
public class TimerB6 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("B6ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedB6", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectB6");
    }
}
