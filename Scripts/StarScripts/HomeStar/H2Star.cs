...
public class H2Star : MonoBehaviour
{
    public Image star1;
    public Image star2;
    public Image star3;
    ...
    void Start()
    {
        starsEarned = PlayerPrefs.GetInt("starsEarnedH2", 0);
        highestStarsEarned = PlayerPrefs.GetInt("highestStarsEarnedH2", 0);

        if (starsEarned > highestStarsEarned)
        {
            highestStarsEarned = starsEarned;
            PlayerPrefs.SetInt("highestStarsEarnedH2", highestStarsEarned);
            PlayerPrefs.Save();
        }
        else
        {
