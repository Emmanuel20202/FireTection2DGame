...
public class TimerB4 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("B4ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedB4", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectB4");
    }
}
