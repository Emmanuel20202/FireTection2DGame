...
public class TimerH5 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("H5ColStar"))
        {
            ...
            PlayerPrefs.SetInt("starsEarnedH5", starsEarned);
    ...
    private IEnumerator LoadNextScene()
    {
        ...
        SceneManager.LoadScene("CorrectH5");
    }
}
